    ...
    \begin{minipage}{0.45\linewidth}
        \begin{center}
            \begin{tikzpicture}
                ...
                \node[] at ($(kv-1-1.north east) + (-4mm, 1.5mm)$) {\tiny CD};
                \node[] at ($(kv-1-1.south west) + (-0.8mm, 3.5mm)$) {\tiny AB};
...
\paragraph{Schema zum Ausfüllen}
\begin{center}
    \small
    \begin{minipage}{0.45\linewidth}
        \begin{center}
            \begin{tikzpicture}
                ...
                \node[] at ($(kv-1-1.north east) + (-4mm, 1.5mm)$) {\tiny CD};
                \node[] at ($(kv-1-1.south west) + (-0.8mm, 3.5mm)$) {\tiny \cemph{AB}};
                \draw[] ($(kv-1-1.north west) + (-1.2mm, 1.2mm)$) -- ($(kv-1-1.south east) + (-1.75mm, 1.75mm)$);
    ...
    \begin{minipage}{0.45\linewidth}
        \begin{center}
            \begin{tikzpicture}
                ...
                \node[] at ($(kv-1-1.north east) + (-4mm, 1.5mm)$) {\tiny \cemph{AB}};
